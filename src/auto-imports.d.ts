...
declare module '@vue/runtime-core' {
  interface ComponentCustomProperties {
    ...
    readonly createCustomFetch: UnwrapRef<typeof import('./composables/cFetch')['createCustomFetch']>
    ...
    readonly useCacheStore: UnwrapRef<typeof import('./store/cache')['useCacheStore']>
